                ...
                <div className="offcanvas-footer">
                    <div className="d-flex gap-2">
                        ...
                        <Link type="button" className="btn btn-success w-100"
                           ...
                           target="_blank">Buy Now</Link>
                    </div>
                    <div className="d-flex gap-2 mt-2">
                        <Link type="button" className="btn btn-primary w-100"
                           to="mailto:teqlathemes@gmail.com.">Support</Link>
                        <Link type="button" className="btn btn-dark w-100" to="https://phpstack-1384472-5121645.cloudwaysapps.com/document/react/ra-admin/">Document</Link>
                    </div>
                </div>
            </div>
        </>
